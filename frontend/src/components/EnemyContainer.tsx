        ...
        <div
            ...
            <div ref={containerDiv}
                ...
                <div className="flex h-[8%] justify-between items-center w-full space-x-4">
                    <div className="flex h-1/3 justify-center ">{player.role}</div>
                    <div className="flex h-1/3 justify-center ">{player.name}</div>
                    <div className="flex h-1/3 justify-center ">{player.hp}</div>
                </div>
                ...
                <div className="flex h-1/12 items-center" onClick={()=> RotatePlayer('home')}>
